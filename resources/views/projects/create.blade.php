...
<div class="container">
    ...
    <main class="main-content">
        ...
        <form action="{{ route('projects.store') }}" method="POST" class="activities info-act" enctype="multipart/form-data">
            @csrf
            ...
            <div>
                <button type="submit" class="stats-button-edit">Crear Projecte</button>
            </div>
        </form>
